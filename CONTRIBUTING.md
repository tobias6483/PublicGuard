...
- Improve local event log privacy controls
...
4. Build locally with `swift build`.
5. Run the test suite with `swift test`.
6. Run `scripts/release_check.sh` when app bundle packaging, release behavior,
   app resources, permissions, or bundled assets changed.
7. Push your branch.
8. Open a pull request against `tobias6483/PublicGuard:main`.
...
documentation gaps. See [SUPPORT.md](SUPPORT.md) for support scope, and report
